<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="accountbalance.aspx.cs" Inherits="FINNETT.ibsui.cop.accountbalance" %>
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 0px;">
                    ...
                    <div class="content-header row" style="background-color: #efefef;">
                        <h5 class="form-section" style="width: 100%;"><i class="fa fa-balance-scale"></i>Account Balance</h5>
                    </div>
                    <div class="row">
                       <div class="col-md-2 text-right">
                        ...
                        <div class="col-md-4 text-left">
                           <asp:DropDownList ID="AccountName" Width="400px" runat="server" Height="25px" class="form-control" OnSelectedIndexChanged="SourceAccountNumber_SelectedIndexChanged" AutoPostBack="true"> </asp:DropDownList>
                        </div>
                        <div class="col-md-2 text-right">
                           Account Number:
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="ACCOUNT NUMBER" ID="AccountNumber" class="form-control" Enabled="false" />
                    ...
                    <div class="row">
                        ...
                        <asp:GridView Style="width: 100%; position: absolute; left: 0px; right: 0px;" OnRowDataBound="OnRowDataBound" CssClass="table table-striped table-responsive-md" OnSelectedIndexChanged="OnSelectedIndexChanged" EmptyDataText="URL not Configured" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AccountBalanceID" GridLines="None" AllowSorting="false">
                            <Columns>
                                ...
                                <asp:BoundField DataField="ClearedBalance" HeaderText="Product Name" SortExpression="ClearedBalance"/>
                                <asp:BoundField DataField="BookedBalance" HeaderText="Booked Balance" SortExpression="BookedBalance"/>
                                <asp:BoundField DataField="BlockedBalance" HeaderText="Blocked Balance" SortExpression="BlockedBalance"/>
                                <asp:BoundField DataField="AvailableBalance" HeaderText="Available Balance" SortExpression="AvailableBalance"/>
                                <asp:BoundField DataField="ArrearsAmount" HeaderText="Arrears Amount" SortExpression="ArrearsAmount"/>
                                <asp:BoundField DataField="BranchName" HeaderText="Branch Name" SortExpression="BranchName"/>
                                <asp:BoundField DataField="MessageDateTime" HeaderText="Balance As At" SortExpression="MessageDateTime" DataFormatString={0:f}/>
                                <asp:TemplateField>
                                    <ItemTemplate>
