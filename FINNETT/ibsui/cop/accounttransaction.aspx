<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="accounttransaction.aspx.cs" Inherits="FINNETT.ibsui.cop.accounttransaction" %>
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 0px;">
                    ...
                    <div class="content-header row" style="background-color: #efefef;">
                        <h5 class="form-section" style="width: 100%;"><i class="fa fa-balance-scale"></i>Account Transactions</h5>
                    </div>               
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" ID="transactionNo" CssClass="form-control" />
                            <asp:RequiredFieldValidator SetFocusOnError="true" ErrorMessage="*" ForeColor="Red" Display="Dynamic" ControlToValidate="transactionNo" runat="server" />
                        </div>
                         <div class="col-md-2 text-right">
                        ...
                        <div class="col-md-4 text-left" style="text-align: right">
                            ...
                            <asp:LinkButton Text="" ID="getstatement" runat="server" OnClick="add_Click"><span class="btn btn-dark"> Get Transactions <i class="fa fa-list-alt"></i></span></asp:LinkButton>
                        </div>
                    </div>
                     <div runat="server" id="drcrinfo" visible="true" class="row" style="padding-bottom: 2px; padding-top: 2px; border-top: 3px double whitesmoke; color: white; background-color: #000000;">
                            ...
                            <div class="col-md-2 pull-left">
                                <asp:Label Text="" Style="font-weight: 700;" ID="_TotalDebits" runat="server" />
                            </div> 
                            <div class="col-md-1 pull-left">
                                Credit:
                            </div>
                            <div class="col-md-2 pull-left">
                                <asp:Label Text="" Style="font-weight: 700;" ID="_TotalCredits" runat="server" />
                            </div> 
                        </div>                  
                    ...
                    <div class="row">
                        ...
                        <asp:GridView Style="width: 100%; position: absolute; left: 0px; right: 0px;"  CssClass="table table-striped table-responsive-md"  EmptyDataText="No Transactions" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="TransactionID" GridLines="None" AllowSorting="false">
                            <Columns>
                                ...
                                <asp:BoundField DataField="TransactionDate" HeaderText="Transaction Date" SortExpression="TransactionDate" DataFormatString={0:f}/>
