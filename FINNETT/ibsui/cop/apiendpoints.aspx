<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="apiendpoints.aspx.cs" Inherits="FINNETT.ibsui.cop.apiendpoints" %>
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 0px;">
                    ...
                    <div class="content-header row" style="background-color: #efefef;">
                        <h5 class="form-section" style="width: 100%;"><i class="fa fa-link"></i>API Endpoints</h5>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="APPLICATION CODE" ID="OperationName" class="form-control"/>
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="OperationName" runat="server" />
                        </div>
                       <div class="col-md-2 text-right">
                           URL End Point:
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="URL END POINT" ID="OperationEndPoint" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="OperationEndPoint" runat="server" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2 text-right">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-10 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="Description" ID="Description" class="form-control" TextMode="MultiLine" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="OperationEndPoint" runat="server" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 text-left">
                           <asp:CheckBox  ID="IsExchangeRate" Text="For ExchangeRate" OnCheckedChanged="IsExchangeRate_CheckedChanged" Checked="true" runat="server"  AutoPostBack="true"/>
                        </div>
                        <div class="col-md-3 text-left">
                           <asp:CheckBox  ID="IsINSSimulation" Text="For INS Simulation" OnCheckedChanged="IsINSSimulation_CheckedChanged" Checked="false" runat="server"  AutoPostBack="true"/>
                        </div>
                        <div class="col-md-3 text-left">
                           <asp:CheckBox  ID="IsAccountMiniStatement" Text="For Ac. Mini Statement" OnCheckedChanged="IsAccountMiniStatement_CheckedChanged" Checked="false" runat="server"  AutoPostBack="true"/>
                        </div>
                         <div class="col-md-3 text-left">
                           <asp:CheckBox  ID="IsPesaLinkSendToAccount" Text="For PesaLink To Account" OnCheckedChanged="IsPesaLinkSendToAccount_CheckedChanged" Checked="false" runat="server"  AutoPostBack="true"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 text-left">
                           <asp:CheckBox  ID="IsPesaLinkSendToPhone" Text="For PesaLink To Phone" OnCheckedChanged="IsPesaLinkSendToPhone_CheckedChanged" Checked="false" runat="server"  AutoPostBack="true"/>
                        </div>
                        <div class="col-md-3 text-left">
                           <asp:CheckBox  ID="IsAccountBalance" Text="For INS Account Balance" OnCheckedChanged="IsAccountBalance_CheckedChanged" Checked="false" runat="server"  AutoPostBack="true"/>
                        </div>
                        <div class="col-md-3 text-left">
                           <asp:CheckBox  ID="IsAccountFullStatement" Text="For Ac. Full Statement" OnCheckedChanged="IsAccountFullStatement_CheckedChanged" Checked="false" runat="server"  AutoPostBack="true"/>
                        </div>
                         <div class="col-md-3 text-left">
                           <asp:CheckBox  ID="IsAccountValidation" Text="For Ac. Validation" OnCheckedChanged="IsAccountValidation_CheckedChanged" Checked="false" runat="server"  AutoPostBack="true"/>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-3 text-left">
                           <asp:CheckBox  ID="AccountTransactions" Text="Account Transactions" OnCheckedChanged="AccountTransactions_CheckedChanged" Checked="false" runat="server"  AutoPostBack="true"/>
                        </div>
                         <div class="col-md-3 text-left">
                           <asp:CheckBox  ID="IFTAccountToAccount" Text="IFT" OnCheckedChanged="IFTAccountToAccount_CheckedChanged" Checked="false" runat="server"  AutoPostBack="true"/>
                        </div>
                    </div>
                    ...
                    <div class="row" style="background-color: #2196f3; text-align: right; padding-bottom: 5px; padding-top: 5px;">
                        ...
                        <div class="col-md-10 text-right">
                            ...
                            &nbsp;
                                        <asp:LinkButton Text="" ID="add" OnClick="add_Click" runat="server"><span class="btn btn-black">Add Account <i class="fa fa-id-card"></i></span></asp:LinkButton>
                            &nbsp;
