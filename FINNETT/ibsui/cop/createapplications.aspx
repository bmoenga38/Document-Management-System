<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createapplications.aspx.cs" Inherits="FINNETT.ibsui.cop.createapplications" %>
...
<head runat="server">
    ...
    <script type="text/javascript"> if (top == self) { window.location.replace("../dsh/modgui/darajaconnect"); } else { } </script>
    <!-- POP CODE-->
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 0px;">
                    ...
                    <div class="content-header row" style="background-color: #efefef;">
                        <h5 class="form-section" style="width: 100%;"><i class="fa fa-file"></i>CO~OP Applications</h5>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="APPLICATION CODE" ID="ApplicationCode" class="form-control"/>
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="ApplicationCode" runat="server" />
                        </div>
                       <div class="col-md-2 text-right">
                           Application Name:
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="APPLICATION NAME" ID="ApplicationName" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="ApplicationName" runat="server" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2 text-right">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="CONSUMER KEY" ID="ConsumerKey" class="form-control"/>
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="ConsumerKey" runat="server" />
                        </div>
                       <div class="col-md-2 text-right">
                           Secret key:
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="SECRET KEY" ID="SecretKey" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="SecretKey" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="API KEY" ID="APIkey" class="form-control"/>
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="APIkey" runat="server" />
                        </div>
                         <div class="col-md-2 text-right">
                           CallBack URL:
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="CALLBACK URL" ID="CallbackUrl" class="form-control"/>
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="CallbackUrl" runat="server" />
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="Token URL" ID="TokenURl" class="form-control"/>
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="TokenURl" runat="server" />
                        </div>
                         <div class="col-md-2 text-right">
                           Revoke URL:
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="Revoke URL" ID="RevokeURL" class="form-control"/>
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="RevokeURL" runat="server" />
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="API URL" ID="ApiUrl" class="form-control"/>
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="ApiUrl" runat="server" />
                        </div>
                         <div class="col-md-2 text-right">
                          
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:CheckBox  ID="IsDefault" Text="Is Default"  Checked="false" runat="server"  AutoPostBack="true"/>
                        </div>
                    ...
                    <div class="row" style="background-color: #2196f3; text-align: right; padding-bottom: 5px; padding-top: 5px;">
                        ...
                        <div class="col-md-10 text-right">
                            ...
                            &nbsp;
                                        <asp:LinkButton Text="" ID="add" OnClick="add_Click" runat="server"><span class="btn btn-black"><i class="fa fa-id-add"></i>Add App</span></asp:LinkButton>
                            &nbsp;
                    ...
                    <div class="row">
                        ...
                        <asp:GridView Style="width: 100%; position: absolute; left: 0px; right: 0px;" OnRowDataBound="OnRowDataBound" CssClass="table table-striped table-responsive-md" OnSelectedIndexChanged="OnSelectedIndexChanged" EmptyDataText="URL not Configured" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ApplicationId" GridLines="None" AllowSorting="false">
                            <Columns>
                                <asp:BoundField DataField="ApplicationCode" HeaderText="App Code" SortExpression="ApplicationCode" />
                                <asp:BoundField DataField="ApplicationName" HeaderText="App Name" SortExpression="ApplicationName" />
                                <asp:BoundField DataField="ConsumerKey" HeaderText="Consumer Key" SortExpression="ConsumerKey" />
                                <asp:BoundField DataField="SecretKey" HeaderText="Secret Key" SortExpression="SecretKey" />    
                                <asp:BoundField DataField="CallbackUrl" HeaderText="Call back Url" SortExpression="CallbackUrl" /> 
                                 <asp:BoundField DataField="ApiUrl" HeaderText="API URL" SortExpression="ApiUrl" /> 
                                <asp:TemplateField>
                                    <ItemTemplate>
