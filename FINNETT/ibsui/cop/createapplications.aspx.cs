...
{
    public partial class createapplications : System.Web.UI.Page
    {
        ...
        protected void update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    RestRequest request = new RestRequest("update/cop/application", Method.POST);
                    ...
                    {
                        ApplicationId = datakey.Text,
                        ApiUrl = ApiUrl.Text,
                        ApplicationCode = ApplicationCode.Text,
                        ...
                        RevokeURL = RevokeURL.Text,
                        TokenURl = TokenURl.Text,
                        Valid = valid.Checked
        ...
        protected void LoadData(int Code, string SearchParameter)
        {
            ...
            RestClient client = new RestClient(SuiteDreamLiner.APIUrul());
            RestRequest request = new RestRequest("get/cop/application", Method.POST);
            request.AddHeader("Accept", "application/json");
            request.AddHeader("Authorization", Secure360.GetAuthorization());
            request.AddHeader("Signature", Secure360.GetSignature());
            var bodyParameters = new
        ...
        protected void add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string hasError = string.Empty;
                    RestClient client = new RestClient(SuiteDreamLiner.APIUrul());
                    RestRequest request = new RestRequest("create/cop/application", Method.POST);
                    request.AddHeader("Accept", "application/json");
                    request.AddHeader("Authorization", Secure360.GetAuthorization());
                    request.AddHeader("Signature", Secure360.GetSignature());
                    var bodyParameters = new
        ...
        protected void PreviewData(string pk)
        {
            ...
            {
                ApplicationCode.Text = receivedData2["ApplicationCode"].ToString();
                ApplicationName.Text = receivedData2["ApplicationName"].ToString();
                ConsumerKey.Text = receivedData2["ConsumerKey"].ToString();
                SecretKey.Text = receivedData2["SecretKey"].ToString();
                IsDefault.Checked = bool.Parse( receivedData2["IsDefault"].ToString());
                APIkey.Text = receivedData2["APIkey"].ToString();
                CallbackUrl.Text = receivedData2["CallbackUrl"].ToString();
                ApiUrl.Text = receivedData2["ApiUrl"].ToString();
                TokenURl.Text = receivedData2["TokenURl"].ToString();
                RevokeURL.Text = receivedData2["RevokeURL"].ToString();
            }
        ...
        protected void ClearData()
        {
            ...
            ApplicationCode.Text = ApplicationName.Text = ConsumerKey.Text = SecretKey.Text =  CallbackUrl.Text = ApiUrl.Text = TokenURl.Text= RevokeURL.Text= APIkey.Text= string.Empty ;
