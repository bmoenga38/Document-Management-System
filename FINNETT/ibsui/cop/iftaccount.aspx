<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iftaccount.aspx.cs" Inherits="FINNETT.ibsui.cop.iftaccount" %>
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 0px;">
                    ...
                    <div class="content-header row" style="background-color: #efefef;">
                        <h5 class="form-section" style="width: 100%;"><i class="fa fa-file-excel-o"></i>Internal Funds Transfer</h5>
                    </div>               
                    <div class="row">
                   ...
                   <div class="row">
                    ...
                    <div class="row" style="background-color: #2196f3; text-align: right; padding-bottom: 5px; padding-top: 5px;" runat="server" visible="true">
                        ...
                        <div class="col-md-10 text-right">
                            ...
                            &nbsp;
                                        <asp:LinkButton Text="" ID="add" OnClick="add_Click" runat="server"><span class="btn btn-black"><i class="fa fa-id-add"></i>Initiate Transaction</span></asp:LinkButton>
                            &nbsp;
                    ...
                    <div class="row">
                        ...
                        <asp:GridView Style="width: 100%; position: absolute; left: 0px; right: 0px;"  CssClass="table table-striped table-responsive-md"  EmptyDataText="No Transactions" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="IFTAccountToAccountID" GridLines="None" AllowSorting="false">
                            <Columns>
                                <asp:BoundField DataField="SourceAccountNumber" HeaderText="Source Account Number" SortExpression="SourceAccountNumber" />
                                <asp:BoundField DataField="DestinationsAccountNumber" HeaderText="Destinations AccountNumber" SortExpression="DestinationsAccountNumber" />
