<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="minstatement.aspx.cs" Inherits="FINNETT.ibsui.cop.minstatement" %>
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 0px;">
                    ...
                    <div class="content-header row" style="background-color: #efefef;">
                     ...
                     <div runat="server" id="Div1" visible="false" class="row" style="padding-bottom: 1px; padding-top: 1px;">
                            <div class="col-md-2 text-right">
                                From Date:
                            </div>
                            <div class="col-md-4 text-left">
                    ...
                    <div class="row" style="background-color: #2196f3; text-align: right; padding-bottom: 5px; padding-top: 5px;" runat="server" visible="true">
                        <div class="col-md-2 text-right">
                            <asp:CheckBox Text="Is Active?" class="checkbox clip-check check-primary checkbox-inline" Checked="true" ID="valid" runat="server" Visible="false" />
                        </div>
                        <div class="col-md-10 text-right">
                            ...
                            &nbsp;
                                        <asp:LinkButton Text="" ID="add" OnClick="add_Click" runat="server"><span class="btn btn-black"><i class="fa fa-id-add"></i>Get Transactions</span></asp:LinkButton>
                            &nbsp;
