...
{
    public partial class mpesaurl : System.Web.UI.Page
    {
        ...
        protected void update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    RestRequest request = new RestRequest("update/mpesa/url", Method.POST);
                    ...
                    {
                        ApiUrlId = datakey.Text,
                        ApiUrlCode = ApiUrlCode.Text,
                        ApiUrlString = ApiUrlString.Text,
                        Valid = valid.Checked
                    };
        ...
        protected void LoadData(int Code, string SearchParameter)
        {
            ...
            RestClient client = new RestClient(SuiteDreamLiner.APIUrul());
            RestRequest request = new RestRequest("get/mpesa/url", Method.POST);
            request.AddHeader("Accept", "application/json");
            request.AddHeader("Authorization", Secure360.GetAuthorization());
            request.AddHeader("Signature", Secure360.GetSignature());
            var bodyParameters = new
        ...
        protected void add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string hasError = string.Empty;
                    RestClient client = new RestClient(SuiteDreamLiner.APIUrul());
                    RestRequest request = new RestRequest("create/mpesa/url", Method.POST);
                    request.AddHeader("Accept", "application/json");
                    request.AddHeader("Authorization", Secure360.GetAuthorization());
                    request.AddHeader("Signature", Secure360.GetSignature());
                    var bodyParameters = new
        ...
        protected void PreviewData(string pk)
        {
            ...
            var bodyParameters = new
            {
                BusinessKey = SuiteDreamLiner.GetBusinessKeyNoEncryption(),
                Code = 1,
            ...
            if (receivedData2 != null)
            {
                ...
                ApiUrlCode.Text = receivedData2["ApiUrlCode"].ToString();
                ApiUrlString.Text = receivedData2["ApiUrlString"].ToString();
            }
