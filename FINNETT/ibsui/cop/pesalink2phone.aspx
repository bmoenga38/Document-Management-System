<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pesalink2phone.aspx.cs" Inherits="FINNETT.ibsui.cop.pesalink2phone" %>
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 0px;">
                    ...
                    <div class="content-header row" style="background-color: #efefef;">
                        <h5 class="form-section" style="width: 100%;"><i class="fa fa-bank"></i>PesaLink To Phone</h5>
                    </div>               
                    <div class="row">
                       <div class="col-md-2 text-right">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="PHONE NUMBER" ID="PhoneNumber" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="PhoneNumber" runat="server" />
                        </div>
                    </div>
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        ...
                        <asp:GridView Style="width: 100%; position: absolute; left: 0px; right: 0px;"  CssClass="table table-striped table-responsive-md"  EmptyDataText="No Transactions" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="PesaLinkSendToPhoneID" GridLines="None" AllowSorting="false">
                            <Columns>
