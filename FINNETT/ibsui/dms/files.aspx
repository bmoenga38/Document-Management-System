<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="files.aspx.cs" Inherits="FINNETT.ibsui.dms.files" %>
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 8px;">
                    ...
                    <div class="content-header row" style="background-color: #efefef;">
                        <h5 class="form-section" style="width: 100%;"><i class="fa fa-file"></i>Files</h5>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="FILE NAME" ID="FileName" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="FileName" runat="server" />
                        </div>
                        <div class="col-md-2 text-right">
                             Folder ID :
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="FILE NAME" ID="FolderID" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="FolderID" runat="server" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="EXTENTION" ID="Extention" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="Extention" runat="server" />
                        </div>
                        <div class="col-md-2 text-right">
                             Size  :
                        </div>
              ...
              <%--      <div class="row">
                         ...
                         <div class="col-md-2 text-right">
                            Branch Name:  DateCreated
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="BRANCH NAME" ID="branchname" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="branchname" runat="server" />
                        </div>
                        <div class="col-md-2 text-right">
                             Branch Code:
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="BRANCH CODE" ID="branchcode" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="branchcode" runat="server" />
                        </div>
                    </div> --%> 
                    ...
                    <div class="row" style="background-color: #2196f3; text-align: right; padding-bottom: 5px; padding-top: 5px;">
                        ...
                        <div class="col-md-10 text-right">
                                        <asp:LinkButton Text="" ID="clearformdata" OnClick="clearformdata_Click" CausesValidation="false" runat="server"><span class="btn btn-info"> Clear Files<i class="fa fa-spinner"></i></span></asp:LinkButton>
                            &nbsp;
                                        <asp:LinkButton Text="" ID="add" OnClick="add_Click" runat="server"><span class="btn btn-black">Add File <i class="fa fa-id-card"></i></span></asp:LinkButton>
                            &nbsp;
                                        <asp:LinkButton Visible="false" Text="" ID="update" OnClick="update_Click" runat="server"><span class="btn btn-success"> Update File <i class="fa fa-magic"></i></span></asp:LinkButton>
                            &nbsp;
