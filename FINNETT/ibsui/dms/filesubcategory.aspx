<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="filesubcategory.aspx.cs" Inherits="FINNETT.ibsui.dms.filesubcategory" %>
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 8px;">
                    ...
                    <div class="content-header row" style="background-color: #efefef;">
                        <h5 class="form-section" style="width: 100%;"><i class="fa fa-file"></i> File SubCategories</h5>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="FILE SUB-CATEGORY CODE" ID="FileSubCategoryCode" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="FileSubCategoryCode" runat="server" />
                        </div>
                        <div class="col-md-2 text-right">
                            File SubCategory Name :  
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="FILE SUB-CATEGORY NAME" ID="FileSubCategoryName" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="FileSubCategoryName" runat="server" />
                        </div>
                    </div>
             <%--       <div class="row">
                    ...
                    <div class="row">
                        ...
                        <asp:GridView Style="width: 100%; position: absolute; left: 0px; right: 0px;" OnRowDataBound="OnRowDataBound" CssClass="table table-striped table-responsive-md" OnSelectedIndexChanged="OnSelectedIndexChanged" EmptyDataText="URL not Configured" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="FileSubCategoryID" GridLines="None" AllowSorting="false">
                            <Columns>
                                <asp:BoundField DataField="FileSubCategoryCode" HeaderText="File SubCategory " SortExpression="FileSubCategoryCode" />
                                <asp:BoundField DataField="FileSubCategoryName" HeaderText="File SubCategory Name" SortExpression="FileSubCategoryName" />
