...
{
    public partial class filesubcategory : System.Web.UI.Page
    {
        ...
        protected void update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    RestRequest request = new RestRequest("update/file/subcategory", Method.POST);
                    ...
                    {
                        FileSubCategoryID = datakey.Text,
                        FileSubCategoryCode = FileSubCategoryCode.Text,
                        FileSubCategoryName = FileSubCategoryName.Text,
        ...
        protected void LoadData(int Code, string SearchParameter)
        {
            ...
            RestClient client = new RestClient(SuiteDreamLiner.APIUrul());
            RestRequest request = new RestRequest("get/file/subcategory", Method.POST);
            request.AddHeader("Accept", "application/json");
            request.AddHeader("Authorization", Secure360.GetAuthorization());
            request.AddHeader("Signature", Secure360.GetSignature());
            var bodyParameters = new
        ...
        protected void add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string hasError = string.Empty;
                    RestClient client = new RestClient(SuiteDreamLiner.APIUrul());
                    RestRequest request = new RestRequest("create/file/Subcategory", Method.POST);
                    request.AddHeader("Accept", "application/json");
                    request.AddHeader("Authorization", Secure360.GetAuthorization());
                    request.AddHeader("Signature", Secure360.GetSignature());
                    var bodyParameters = new
        ...
        protected void PreviewData(string pk)
        {
            ...
            {
                FileSubCategoryCode.Text = receivedData2["FileSubCategoryCode"].ToString();
                FileSubCategoryName.Text = receivedData2["FileSubCategoryName"].ToString();
