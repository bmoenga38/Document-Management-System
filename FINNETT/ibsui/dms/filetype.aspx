<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="filetype.aspx.cs" Inherits="FINNETT.ibsui.dms.filetype" %>
                ...
                <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 8px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="FILE TYPE CODE" ID="FileCategoryCode" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="FileCategoryCode" runat="server" />
                        </div>
                        <div class="col-md-2 text-right">
                            File Type Name :  
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="FILE TYPE NAME " ID="FileCategoryName" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="FileCategoryName" runat="server" />
                        </div>
                    </div>
             <%--       <div class="row">
