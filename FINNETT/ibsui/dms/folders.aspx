<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="folders.aspx.cs" Inherits="FINNETT.ibsui.dms.folders" %>
...
<head runat="server">
    ...
    <script type="text/javascript"> if (top == self) { window.location.replace("../dsh/modgui/dmsconnect"); } else { } </script>
    <!-- POP CODE-->
    ...
    <form runat="server">
        ...
        <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="AA">
            <ContentTemplate>
                ...
                <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 8px;">

                    <div class="content-header row" style="background-color: #efefef;">
                        <h5 class="form-section" style="width: 100%;"><i class="fa fa-file"></i>Folders</h5>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="FOLDER CODE" ID="FolderName" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="FolderName" runat="server" />
                        </div>
                        <div class="col-md-2 text-right">
                            Folder Name :
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="FOLDER NAME" ID="FolderPath" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="FolderPath" runat="server" />
                        </div>
                    </div> 
                   ...
                   <%-- 2rd Row--%>
                    <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="SOURCE ID" ID="SourceID" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="SourceID" runat="server" />
                        </div>
                        <div class="col-md-2 text-right">
                             Size  :
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="SIZE" ID="Size" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="Size" runat="server" />
                        </div>
                    </div>
                   ...
                   <%-- 3rd Row--%>
                     <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="NUMBER OF ITEMS" ID="NumberOfItems" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="NumberOfItems" runat="server" />
                        </div>
                        <div class="col-md-2 text-right">
                            Date Modified :
                        </div>
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="DATE MODIFIED" ID="DateModified" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="DateModified" runat="server" />
                        </div>
                    </div>  
                    ...
                    <%-- 4th Row--%>
                     <div class="row">
                        ...
                        <div class="col-md-4 text-left">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="DATE CREATED" ID="DateCreated" class="form-control" />
                            <asp:RequiredFieldValidator ErrorMessage="*" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="DateCreated" runat="server" />
                        </div>
                    ...
                    <div class="row" style="background-color: #2196f3; text-align: right; padding-bottom: 5px; padding-top: 5px;">
                        ...
                        <div class="col-md-10 text-right">
                                        <asp:LinkButton Text="" ID="clearformdata" OnClick="clearformdata_Click" CausesValidation="false" runat="server"><span class="btn btn-info"> Clear Folder<i class="fa fa-spinner"></i></span></asp:LinkButton>
                            &nbsp;
                                        <asp:LinkButton Text="" ID="add" OnClick="add_Click" runat="server"><span class="btn btn-black">Add Foldee <i class="fa fa-id-card"></i></span></asp:LinkButton>
                            &nbsp;
                                        <asp:LinkButton Visible="false" Text="" ID="update" OnClick="update_Click" runat="server"><span class="btn btn-success"> Update Folder <i class="fa fa-magic"></i></span></asp:LinkButton>
                            &nbsp;
                                        <asp:LinkButton Text="" ID="refreshdata" OnClick="refreshdata_Click" Visible="false" CausesValidation="false" runat="server"><span class="btn btn-black"> Refresh Files <i class="fa fa-spinner"></i></span></asp:LinkButton>
                            &nbsp;
                    ...
                    <div class="row">
                        ...
                        <asp:GridView Style="width: 100%; position: absolute; left: 0px; right: 0px;" OnRowDataBound="OnRowDataBound" CssClass="table table-striped table-responsive-md" OnSelectedIndexChanged="OnSelectedIndexChanged" EmptyDataText="URL not Configured" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="FolderID" GridLines="None" AllowSorting="false">
                            <Columns>
                                <asp:BoundField DataField="FolderName" HeaderText="Folder Code" SortExpression="FolderName" />
                                <asp:BoundField DataField="FolderPath" HeaderText="Folder Name " SortExpression="FolderPath" />
                                <asp:BoundField DataField="SourceID" HeaderText="SourceID" SortExpression="SourceID" />
                                <asp:BoundField DataField="Size" HeaderText="Size" SortExpression="Size" />
                                <asp:BoundField DataField="NumberOfItems" HeaderText="NumberOfItems " SortExpression="NumberOfItems" InsertVisible="True" />
                                <asp:BoundField DataField="DateModified" HeaderText="DateModified " SortExpression="DateModified" InsertVisible="True" />
                                <asp:BoundField DataField="DateCreated" HeaderText="DateCreated " SortExpression="DateCreated" InsertVisible="True" />

<%--                                <asp:BoundField DataField="BranchCode" HeaderText="Branch Code" SortExpression="BranchCode" /> maid
