<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="businessverification.aspx.cs" Inherits="FINNETT.ibsui.dsh.modgui.businessverification" %>
        ...
        <div class="container-fluid container-fullw bg-white" style="position: relative; margin-top: 0px; border-top: 4px solid #404e67; border-bottom: 4px solid #404e67; border-radius: 0px;" >
            <div class="row" >
                ...
                <div class="col-4">
                    ...
                    <div class="row">
                        <div class="col-7">
                            <asp:TextBox AutoCompleteType="Disabled" runat="server" placeholder="Business Name" ID="businessname"  class="form-control" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-7">
                            <asp:button text="Verify Business" runat="server" Onclick="businessOnClick"/>
                        </div>
                        <div class="col-4">
