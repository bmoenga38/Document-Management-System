<%@ Page Language="C#" ViewStateEncryptionMode="Auto" EnableViewState="false" AutoEventWireup="true" CodeBehind="coopconnect.aspx.cs" Inherits="FINNETT.ibsui.dsh.modgui.coopconnect" %>
            ...
            <div class="ks-wrapper">
                <nav class="nav navbar-nav">
                    <div class="ks-navbar-menu">
                        ...
                        <div runat="server" id="ussd" visible="true" class="nav-item dropdown">
                        ...
                        <div runat="server" id="banking_360" visible="true" class="nav-item dropdown">
                        ...
                        <div runat="server" id="field_capture" visible="true" class="nav-item dropdown">
                        ...
                        <div runat="server" id="mpesa" visible="true" class="nav-item dropdown">
                        ...
                        <div runat="server" id="Div1" visible="true" class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="PPMPESA" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div runat="server" id="crb" visible="true" class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="CRB" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                <i style="font-size: small;" class="la la-street-view"></i>&nbsp;CRB
                            </a>
                            <div class="dropdown-menu ks-info" aria-labelledby="Preview">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li runat="server" id="mpesa_settings" class="nav-item dropdown" visible="true">
                            ...
                            <div class="dropdown-menu">                               
                                <a class="dropdown-item" href="~/ibsui/cop/createaccount" target="UNILoaderV" runat="server" id="identity_types" visible="true"><i class="fa fa-object-group"></i>&nbsp;Create Account</a>
                                <a class="dropdown-item" href="~/ibsui/cop/accountcredentials" target="UNILoaderV" runat="server" id="A1" visible="false"><i class="fa fa-sitemap"></i>&nbsp; Account Credentials</a>
                                <a class="dropdown-item" href="~/ibsui/cop/createapplications" target="UNILoaderV" runat="server" id="command_types" visible="true"><i class="fa fa-sitemap"></i>&nbsp;CO~OP Application</a>
                                <a class="dropdown-item" href="~/ibsui/cop/apiendpoints" target="UNILoaderV" runat="server" id="request_codes" visible="true"><i class="fa fa-sitemap"></i>&nbsp;CO~OP Endpoints</a>
                                <a class="dropdown-item" href="~/ibsui/cop/abcxshortcodetypes" target="UNILoaderV" runat="server" id="shortcode_types" visible="false"><i class="fa fa-sitemap"></i>&nbsp;CO~OP Operations settings</a>
                            </div>
                        </li>
